namespace WindowsFormsApplication5
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this._lblFilename = new System.Windows.Forms.LinkLabel();
			this.SuspendLayout();
			// 
			// button1
			// 
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(198, 137);
			...
			this._lblFilename.Location = new System.Drawing.Point(12, 102);
			this._lblFilename.Name = "_lblFilename";
			this._lblFilename.Size = new System.Drawing.Size(16, 13);
			this._lblFilename.TabIndex = 5;
			this._lblFilename.TabStop = true;
			this._lblFilename.Text = "...";
			this._lblFilename.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.OnLinkClicked);
			// 
			// Form1
			// 
		...
		private System.Windows.Forms.LinkLabel _lblFilename;
	}
}
